module params
  ...
  real(dp), parameter :: Omega_b      = .1d0
  real(dp), parameter :: Omega_m      = .4d0
  real(dp), parameter :: Omega_r      = 8.3d-5
  real(dp), parameter :: Omega_nu     = 0.d0
  real(dp), parameter :: Omega_lambda = 0.d0!1.d0 - Omega_m - Omega_b - Omega_r - Omega_nu
  real(dp), parameter :: T_0          = 2.725d0
  real(dp), parameter :: n_s          = .96d0
